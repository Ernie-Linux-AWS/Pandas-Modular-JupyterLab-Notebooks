...
from imports import does_the_CSV_file_exist as E_does_the_CSV_file_exist
from imports import write_dataframe_to_CSV as E_write_dataframe_to_CSV
import gc
import pandas as pd
#
'''
...
#
name_dir = './data/'
name_file_CSV = 'carsales.csv'
name_filepath = name_dir + name_file_CSV
flag_create = E_does_the_CSV_file_exist(
    name_dir, name_filepath)
if not flag_create:
